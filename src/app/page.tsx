...
import { FaDiscord, FaPlane, FaPlaneDeparture, FaUsers, FaYoutube } from 'react-icons/fa';
      ...
      <div className="hero cinematic-hero">
        ...
        <div className="container hero-content text-center fade-in-up">
          ...
          <div className="hero-buttons">
            <a href="#active-flights" className="btn btn-red btn-glass" style={{ fontSize: '1.1rem', padding: '16px 36px' }}>
              View Active Flights
            </a>
            <Link href="/FlightDepo" className="btn btn-white btn-glass" style={{ fontSize: '1.1rem', padding: '16px 36px' }}>
              Staff Portal
            </Link>
          </div>
        </div>
      ...
      <div id="active-flights" className="container section">
        <div className="text-center" style={{ marginBottom: '64px' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', marginTop: '8px' }}>
            Join a live PTFS flight hosted by our staff.
          </p>
        </div>
        ...
        {activeFlights.length === 0 ? (
          <div
            ...
            style={{ textAlign: 'center', padding: '64px 24px', borderRadius: 'var(--radius)', border: '1px solid var(--border)' }}
          >
        ...
        <div className="community-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
          <div className="glass-panel interactive-card text-center" style={{ padding: '40px' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', marginBottom: '24px' }}>
              Official Air Canada PTFS carrier group with 7,000+ members.
            </p>
            <a
              href="https://www.roblox.com/communities/811457361/Air-Canada-PTFS-Group#!/about"
              target="_blank"
          ...
          <div className="glass-panel interactive-card text-center" style={{ padding: '40px' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', marginBottom: '24px' }}>
              Watch our latest flight events, cinematic reels, and tutorials.
            </p>
            <a
              href="https://www.youtube.com/@Air.CanadaPTFS"
              target="_blank"
              rel="noopener noreferrer"
              className="btn btn-outline w-full"
          ...
          <div className="glass-panel interactive-card text-center" style={{ padding: '40px' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', marginBottom: '24px' }}>
              The hub for all our operations, communications, and live events.
            </p>
            <a href="https://discord.gg/aircanada" target="_blank" rel="noopener noreferrer" className="btn btn-discord w-full">
              Join Discord
            </a>
          </div>
        </div>
