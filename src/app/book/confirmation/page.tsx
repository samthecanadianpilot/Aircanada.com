  ...
  if (!booking) {
    return (
      <div className="container section text-center">
        ...
        <Link href="/tracker" className="btn btn-red">
          Browse Flights
        </Link>
      </div>
    );
        ...
        <div className="boarding-pass">
          <div className="bp-header">
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <Image src="/logo-white.png" className="logo-dark-mode" alt="Air Canada" width={88} height={20} style={{ height: '20px', width: 'auto' }} />
              <Image src="/logo-black.png" className="logo-light-mode" alt="Air Canada" width={88} height={20} style={{ height: '20px', width: 'auto' }} />
            </div>
          ...
          <div className="bp-body">
            <div className="bp-row">
              ...
              <span className="bp-value">{booking.passengerName}</span>
            </div>
            <div className="bp-row">
              <span className="bp-label">Seat</span>
              <span className="bp-value" style={{ color: 'var(--ac-red)', fontSize: '1.3rem' }}>
                {booking.seat}
              </span>
            </div>
            <div className="bp-row">
              <span className="bp-label">Reference</span>
              <span className="bp-value" style={{ fontFamily: 'monospace' }}>
                {booking.refNumber}
              </span>
            </div>
          </div>
